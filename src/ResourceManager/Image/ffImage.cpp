...
ffImage ffCreateImage(const VmaAllocator& Allocator, const VkDevice& Device, ffImageCreateInfo pCreateInfo, VmaAllocationCreateInfo pAllocationInfos)
{
    ...
    if (vmaCreateImage(Allocator, &vkCreateInfo, &pAllocationInfos, &n.Handle, &n.Memory, &n.AllocationInfos))
        return n;
    ...
    if (pCreateInfo.AsView) {
        ...
        ImageViewCreateInfo.subresourceRange = {
            pCreateInfo.ViewInfos.AspectMask,
            0, 1, 0, 1
        };

...
inline VkQueue GetGraphicQueue() { return GlobalEnvironmentPTR->GPUInfos.Queues[GlobalEnvironmentPTR->GPUInfos.GraphicQueueIndex]; }
inline VkQueue GetPresentQueue() { return GlobalEnvironmentPTR->GPUInfos.Queues[GlobalEnvironmentPTR->GPUInfos.PresentQueueIndex]; }
inline VkQueue GetTransferQueue() { return GlobalEnvironmentPTR->GPUInfos.Queues[GlobalEnvironmentPTR->GPUInfos.TransferQueueIndex]; }
...
inline uint32_t GetTransferQueueIndex() { return GlobalEnvironmentPTR->GPUInfos.QueueIndex[GlobalEnvironmentPTR->GPUInfos.TransferQueueIndex]; }
inline uint32_t GetGraphicQueueIndex() { return GlobalEnvironmentPTR->GPUInfos.QueueIndex[GlobalEnvironmentPTR->GPUInfos.GraphicQueueIndex]; }

...
namespace gr {
    ...
    class Buffer {
        ...
        protected:
            Error initBuffer(const Manager& grm, VkBufferCreateInfo bufferInfos, VmaAllocationCreateInfo allocInfos, VkDeviceSize size);
    ...
    class VertexBuffer : public Buffer {
        public:
             ...
             */
            Error init(const Manager& grm, void *data, VkDeviceSize elementCount, VkDeviceSize elementStride, std::vector<AttributeDescription> description, VkPrimitiveTopology topology);
    ...
    class IndexBuffer : public Buffer {
        public:
             ...
             * @return Error - Returns Error::NONE if initialization is successful.
             */
            Error init(const Manager& grm, void *data, VkDeviceSize elementCount, VkDeviceSize elementStride);
    ...
    class UniformBuffer : public Buffer {
        public:
             ...
             * @return Error - Returns Error::NONE if initialization is successful.
             */
            Error init(const Manager& grm, void *data, VkDeviceSize elementStride, uint32_t binding);

...
Resource NewResources(const VkDevice& Device) {
    ...
    std::vector<const char*> ShaderNames = {"./shaders/Geo2D.vert.spirv", "./shaders/Geo3D.vert.spirv",
                                            "./shaders/Color.frag.spirv"};
    std::vector<VkShaderStageFlagBits> ShaderStage = {VK_SHADER_STAGE_VERTEX_BIT, VK_SHADER_STAGE_VERTEX_BIT,
